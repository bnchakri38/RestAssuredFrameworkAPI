...
public class AmadeusAPITest extends BaseTest {
	...
	public void getOAuth2Token() {
		...
		Response response = restClient.post(BASE_URL_OAUTH2_AMADEUS, AMADEUS_OATUH2_TOKEN_ENDPOINT, ConfigManager.get("clientid_amadeus"), 
													ConfigManager.get("clientsecret_amadeus"), ConfigManager.get("granttype"), ContentType.URLENC);
